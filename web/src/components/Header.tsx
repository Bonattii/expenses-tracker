...
export default function Header() {
  return (
    <section id="header" className="bg-primary-500">
      <div className="grid max-w-2xl md:max-w-2xl lg:max-w-7xl px-2 py-8 mx-auto lg:gap-8 xl:gap-0 lg:px-8 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
          <h1 className="text-center lg:text-left max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl text-white">
